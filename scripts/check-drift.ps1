...
.PARAMETER CureSoftDrift
    ...
    user-preference keys (theme, effortLevel, outputStyle, agentPushNotifEnabled,
...
'@
            ...
            try {
                ...
                $softKeys = '["theme","effortLevel","outputStyle","agentPushNotifEnabled","inputNeededNotifEnabled"]'
