...
# including any managed sub-blocks (e.g. the ctx7-managed block in the Codex
# Ground Rules) — the new convention forbids private tracker IDs anywhere in a
# shipped framework rule section, so nothing is comment-exempt.
