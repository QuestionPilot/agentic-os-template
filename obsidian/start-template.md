...
This is the kickoff entry point — AI agents read this every session to ground orient. See `ai-config/obsidian/vault-guide.md` §7 for the minimum-contract shape.
