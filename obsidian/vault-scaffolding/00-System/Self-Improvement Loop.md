...
- Did we learn anything that should change future behavior?
- Is the lesson already represented in the right source of truth?
- Can it become a check or script instead of prose?
- Does Linear need a follow-up issue?
- Does Memory Vault need a durable note?
- Did the work reveal a missing silver platter, unclear source path, or unbounded goal-run?

## Dream Review

Use [[00-System/Dream Review]] to periodically convert repeated work, stale memory, tool drift, and source gaps into reviewed recommendations.
